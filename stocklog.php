...
<body>
    ...
    <p><a href="add6.php"><button>Record Income</button></a></p>
    <p><a href="add7.php"><button>Record Expense</button></a></p>
    ...
    <table border="1">
        ...
        $sql = "SELECT * FROM stocktransactionlog ORDER BY Date_1";
